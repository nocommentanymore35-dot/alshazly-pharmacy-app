    ...
    <View style={styles.cartItem}>
      {item.imageUrl ? (
        ...
        <View style={[styles.itemImage, { backgroundColor: "#E8EDF3", justifyContent: "center", alignItems: "center" }]}>
          <MaterialIcons name="medication" size={30} color="#1A3C6E" />
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  itemPrice: { fontSize: 13, color: "#1A3C6E", fontWeight: "600" },
  itemQty: { fontSize: 13, color: "#6B7280" },
  itemTotal: { fontSize: 14, fontWeight: "bold", color: "#1A3C6E", marginTop: 4, textAlign: "right" },
  ...
  totalAmount: { fontSize: 22, fontWeight: "bold", color: "#1A3C6E" },
  checkoutBtn: {
