  ...
  const renderFavoriteItem = ({ item }: { item: FavoriteItem }) => (
    ...
    >
      ...
      <View style={styles.actions}>
        ...
        >
          <MaterialIcons name="shopping-cart" size={18} color={isInCart(item.medicineId) ? "#9CA3AF" : "#1A3C6E"} />
        </Pressable>
        <Pressable
...
const styles = StyleSheet.create({
  ...
  itemPrice: { fontSize: 15, fontWeight: "bold", color: "#1A3C6E", marginTop: 4, textAlign: "right" },
