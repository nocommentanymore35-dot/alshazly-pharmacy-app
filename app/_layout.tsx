...
import { AdminOrderChecker } from "@/components/AdminOrderChecker";
...
// Configure smooth fade out animation (1 second)
...
export default function RootLayout() {
  ...
  // Wait a brief moment for the app to fully render, then hide splash with fade
  useEffect(() => {
    async function prepare() {
      try {
        // Small delay to ensure content is rendered before hiding splash
