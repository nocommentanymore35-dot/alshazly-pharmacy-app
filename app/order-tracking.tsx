...
const styles = StyleSheet.create({
  ...
  timelineLabelCurrent: { color: "#1A3C6E", fontWeight: "bold" },
  ...
  itemPrice: { fontSize: 14, fontWeight: "bold", color: "#1A3C6E" },
  totalRow: {
    flexDirection: "row", justifyContent: "space-between", alignItems: "center",
  ...
  paymentText: { fontSize: 15, fontWeight: "600", color: "#1A3C6E" },
});
